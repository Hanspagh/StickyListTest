package app.jobsandgates.stickyheadertest;
...
import app.jobsandgates.stickyheadertest.adapters.BigramHeaderAdapter;
import app.jobsandgates.stickyheadertest.adapters.InitialHeaderAdapter;
import app.jobsandgates.stickyheadertest.adapters.PersonAdapter;
import app.jobsandgates.stickyheadertest.data.PersonDataProvider;
...
public class MainActivity extends ActionBarActivity implements OnHeaderClickListener {
    ...
    public void move(View v) {
        for(int i = 0; i < 3 ; i++){
            personDataProvider.move();
            personAdapter.notifyItemMoved(0,personDataProvider.getItems().size()-1);
        }
    }
