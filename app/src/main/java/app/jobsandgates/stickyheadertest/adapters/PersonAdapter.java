package app.jobsandgates.stickyheadertest.adapters;
...
import app.jobsandgates.stickyheadertest.R;
import app.jobsandgates.stickyheadertest.data.PersonDataProvider;
import app.jobsandgates.stickyheadertest.listeners.OnRemoveListener;
